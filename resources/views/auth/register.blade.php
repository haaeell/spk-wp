            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="jenis_pasien" class="col-md-4 col-form-label text-md-end">{{ __('Jenis Pasien') }}</label>

                            <div class="col-md-6">
                                <select id="jenis_pasien" class="form-control @error('jenis_pasien') is-invalid @enderror" name="jenis_pasien" required>
                        ...
                        <div class="row mb-3">
                            <label for="poli_id" class="col-md-4 col-form-label text-md-end">{{ __('Ruangan Poli') }}</label>

                            <div class="col-md-6">
                                <select id="poli_id" class="form-control @error('poli_id') is-invalid @enderror" name="poli_id" required>
